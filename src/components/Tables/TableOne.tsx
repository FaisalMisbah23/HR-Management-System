...
import { Leave } from '../../types/package';


const TableOne = ({data,setEdit,openDeleteModal}) => {
  return (
              ...
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    ...
                    <button onClick={()=>setEdit(packageItem)} className="hover:text-primary">
	...
	<path fill="currentColor" d="M5 21h14c1.103 0 2-.897 2-2v-8.668l-2 2V19H8.158c-.026 0-.053.01-.079.01c-.033 0-.066-.009-.1-.01H5V5h6.847l2-2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2" />
                    ...
                    <button onClick={()=>openDeleteModal(packageItem._id)} className="hover:text-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 24 24">
