...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-yellow-100 hover:text-textdark ${
                          (pathname === '/' ||
                            pathname.includes('dashboard')) &&
                          'bg-yellow-100 text-textdark'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
              ...
              <li>
                <NavLink
                  to="/admin/calendar"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-yellow-100 dark:hover:bg-meta-4 ${
              ...
              <li>
                <NavLink
                  to="/admin/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-yellow-100 dark:hover:bg-meta-4 ${
                    pathname.includes('profile') && 'bg-yellow-100 text-textdark'
                  }`}
                >
                  <svg
                    className="fill-current"
          ...
          <div>
            ...
            <li>
                <NavLink
                  to="/admin/emplyeemanagement"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-yellow-100 hover:text-textdark ${
                    pathname.includes('chart') && 'bg-yellow-100 text-textdark'
                  }`}
                >
                                    <svg
                    className="fill-current"
              ...
              <SidebarLinkGroup
                activeCondition={pathname === '/leavemanagement' || pathname.includes('leavemanagement')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-yellow-100 hover:text-textdark ${
                          (pathname === '/leavemanagement' || pathname.includes('leavemanagement')) &&
                          'bg-yellow-100 text-textdark'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
	...
	<g fill="currentColor" fill-rule="evenodd" clip-rule="evenodd">
		<path d="M10.08 4.304L2.244 3.019A1.5 1.5 0 0 0 .5 4.5v9.738a1.5 1.5 0 0 0 1.268 1.482l8.155 1.275a.5.5 0 0 0 .577-.494V4.797a.5.5 0 0 0-.42-.493m-8-.298L9.5 5.222v10.694L1.923 14.73a.5.5 0 0 1-.423-.493V4.5a.5.5 0 0 1 .58-.494" />
		<path d="M18 3a1.5 1.5 0 0 0-.243.02L9.92 4.303a.5.5 0 0 0-.419.493V16.5a.5.5 0 0 0 .577.494l8.155-1.275a1.5 1.5 0 0 0 1.268-1.482V4.5A1.5 1.5 0 0 0 18 3m.077 11.73L10.5 15.917V5.222l7.42-1.216a.501.501 0 0 1 .58.494v9.737a.5.5 0 0 1-.423.493" />
	</g>
</svg>
                        Leave Management
                        <svg
                      ...
                      >
                        ...
                        <li>
                            <NavLink
                              to="/admin/leavemanagement/manageleaves"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          <li>
                            <NavLink
                              to="/admin/leavemanagement/leaveplan"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          <li>
                            <NavLink
                              to="/admin/leavemanagement/leavehistroy"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
              ...
              {/* <!-- Menu Item Ui Elements --> */}
              <SidebarLinkGroup
                activeCondition={pathname === '/performancemanagement' || pathname.includes('performancemanagement')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-yellow-100 hover:text-textdark ${
                          (pathname === '/performancemanagement' || pathname.includes('performancemanagement')) &&
                          'bg-yellow-100 text-textdark'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
		...
		<path d="M18 3a1.5 1.5 0 0 0-.243.02L9.92 4.303a.5.5 0 0 0-.419.493V16.5a.5.5 0 0 0 .577.494l8.155-1.275a1.5 1.5 0 0 0 1.268-1.482V4.5A1.5 1.5 0 0 0 18 3m.077 11.73L10.5 15.917V5.222l7.42-1.216a.501.501 0 0 1 .58.494v9.737a.5.5 0 0 1-.423.493" />
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/admin/performancemanagement/targetsetup"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          <li>
                            <NavLink
                              to="/admin/performancemanagement/target"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
